package org.giwi.networkgraph.lib.graph.view;
...
import org.giwi.networkgraph.lib.beans.RandomLocationTransformer;
...
import org.giwi.networkgraph.lib.layout.AbstractLayout;
    ...
    public synchronized void step() {
        ...
        while (true) {
            try {
                ...
                Log.e(org.giwi.networkgraph.lib.layout.FRLayout.class.getName(), cme.getMessage());
            }
        }
        while (true) {
            try {
